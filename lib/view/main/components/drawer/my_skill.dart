...
class MySKills extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Column(
      ...
      children: [
        AnimatedLinearProgressIndicator(percentage: 0.7, title: 'HTML',image: 'assets/icons/flutter.png',),
        AnimatedLinearProgressIndicator(percentage: 0.9, title: 'CSS',image: 'assets/icons/dart.png'),
        AnimatedLinearProgressIndicator(percentage: 0.6, title: 'PHP',image: 'assets/icons/firebase.png'),
        AnimatedLinearProgressIndicator(percentage: 0.85, title: 'MySQL',image: 'assets/icons/dart.png'),
        AnimatedLinearProgressIndicator(percentage: 0.7, title: ' Bootstrap',image: 'assets/icons/flutter.png',),
        AnimatedLinearProgressIndicator(percentage: 0.9, title: 'Flutter',image: 'assets/icons/dart.png'),
